---
name: octoswitch-delegate-inherit-worker
description: Execute a delegated OctoSwitch task in a fresh subagent using the current conversation model.
model: inherit
---
...
- launched worker: `octoswitch:octoswitch-delegate-inherit-worker`
- runtime model mode: `inherit`
