---
name: octoswitch-delegate-opus-worker
description: Execute a delegated OctoSwitch task in a fresh subagent using the Opus model tier.
model: opus
---
...
- launched worker: `octoswitch:octoswitch-delegate-opus-worker`
- runtime model mode: `opus`
